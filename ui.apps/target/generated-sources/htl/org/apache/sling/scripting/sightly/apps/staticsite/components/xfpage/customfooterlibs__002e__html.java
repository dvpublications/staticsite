 ...
 * under the License.
 ******************************************************************************/
package org.apache.sling.scripting.sightly.apps.staticsite.components.xfpage;
                            ...
                            for (Object item : var_collectionvar5_list_coerced$) {
                                {
                                    ...
                                    if (var_traversal14) {
                                        out.write("\n    ");
                                        {
                                            boolean var_testvariable17 = (org.apache.sling.scripting.sightly.compiler.expression.nodes.BinaryOperator.strictEq(renderContext.getObjectModel().resolveProperty(renderContext.getObjectModel().resolveProperty(item, "location"), "name"), "footer"));
